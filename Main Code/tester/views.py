...
def home_paper(request):
    return render(request, 'tester/index.html',{'messages':'nbvjnosrn'})
...
class MCQ10TestCreateView(LoginRequiredMixin, CreateView):
...
class MCQ25TestCreateView(LoginRequiredMixin,  CreateView):
